...
import com.adoraitunes.dao.mongo.CancionesDAO;
import com.adoraitunes.dao.mongo.UsuarioDAO;
...
import com.adoraitunes.security.UserAuthenticator;
...
public class AppModule
{
    public static void bind(ServiceBinder binder)
    {
        ...
        binder.bind(IUsuarioService.class, UsuarioService.class);
        binder.bind(IAdminService.class, AdminService.class);
        binder.bind(ICancionesService.class, CancionesService.class);

        binder.bind(IUsuarioDAO.class, UsuarioDAO.class);
        binder.bind(ICancionesDAO.class, CancionesDAO.class);

        binder.bind(IPasswordManager.class, PasswordManager.class);
        binder.bind(JongoClient.class);
    ...
    public static void contributeWebSecurityManager(Configuration<Realm> configuration, @Autobuild UserAuthenticator realm) {
